                            ...
                            <tbody>
                                ...
                                <?php foreach ($kunker as $kunjungan): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <img src="<?= $kunjungan->gamlap ?>" alt="Gambar" style="width: 250px;">
                                        </td>

                                        <td>
                                            <a href="<?= base_url('kunjungan/' . $kunjungan->id . '/edit') ?>"
                                                class="btn btn-sm btn-outline-secondary">Edit</a>
                                            <a href="#" data-href="<?= base_url('kunjungan/' . $kunjungan->id . '/delete') ?>"
