    ...
    <div id="content">
        ...
        <div class="container">
            <div class="wrapper my-5 mx-auto" style="max-width: 540px">
                <form action="<?= base_url(); ?>kredit/create" method="post" id="form-slide"
                    ...
                    <div id="slide">
                        <div class="form-group">
                            ...
                            <div class="d-flex align-items-center justify-content-around">
                                ...
                                <input type="text" class="form-control" name="id_petugas" value="<?= user()->id; ?>"
                                    hidden />
                                <input name="nama_petugas" value="<?= user()->fullname; ?>" type="text"
                                    class="form-control" hidden>
                                <input class="form-control" name="tgl_daftar" value="<?= date('Y-m-d H:i:s'); ?>"
                                    hidden />
                                <input name="stts_pnd" value="Pemberkasan dan Registrasi" type="text"
                                    class="form-control" hidden />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="d-flex align-items-center justify-content-around">
                                <input name="jangka" type="text" class="form-control"><span class="input-group-text"
                    ...
                    <div id="slide">
                        <h3 class="h3">DATA PEMOHON</h3>
                        <hr>
                        <div class="form-group">
                            <label> Nama KTP</label>
                            <div class="d-flex align-items-center justify-content-around">
                                <input name="nama_pem" type="text" class="form-control" placeholder="Sesuai KTP">
                                <select name="jenis_pem" class="form-control bg-primary"
                                    style="width: 135px;color:white;" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="d-flex align-items-center justify-content-around">
                                <input name="jumlah_tang" id="input9" type="text" class="form-control"><span
                                    class="input-group-text" id="basic-addon2">Orang</span>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="d-flex align-items-center justify-content-around">
                                ...
                                <select name="jenis_pas" class="form-control bg-primary"
                                    style="width: 135px;color:white;" required>
                                    <option value='Laki-laki'>Laki-laki</option>
                                    <option value='Perempuan'>Perempuan</option>
                                </select>
                    ...
                    <div id="slide">
                        <h3 class="h3">Keterangan Tempat Tinggal</h3>
                        <hr>
                        ...
                        <div class="form-group">
                            ...
                            <div class="d-flex align-items-center justify-content-around">
                                <input name="lama" type="text" class="form-control"><span class="input-group-text"
                    ...
                    <div id="slide">
                        <h3 class="h3">Informasi Pekerjaan / Usaha dan Keuangan</h3>
                        <hr>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Lama</label>
                            <div class="d-flex align-items-center justify-content-around ">
                                <input name="lama2" type="text" class="form-control"><span
                                    class="input-group-text">Tahun</span>
                            </div>
                        </div>
                    ...
                    <div id="slide">
                        <h3 class="h3">Informasi Agunan</h3>
                        <hr>
                        <div class="form-group">
                    ...
                    <div id="slide">
                        ...
                        <div class="form-group">
                            ...
                            <div class="d-flex align-items-center justify-content-around">
                                <input name="angsuran" class="form-control" type="text"><span class="input-group-text"
                                    id="basic-addon2">Per Bulan</span>
                            </div>
                        </div>
                        <div class="form-group">
                    ...
                    <div id="slide">
                        <h3 class="h3">Bukti Tanda Tangan</h3>
                        <hr>
                        <div class="form-group">
